...
class EventFilterStub:
    ...
    def create_json(cls):
        ...
        return event_filter_faker.generate(use_defaults=True, use_examples=True)
    ...
    def create_instance(cls) -> "EventFilter":
        ...
        if json is None:
            ...
            backup_faker = JSF(EventFilterAdapter.json_schema(), allow_none_optionals=1)
            json = backup_faker.generate(use_defaults=True, use_examples=True)
        return EventFilterAdapter.validate_python(
