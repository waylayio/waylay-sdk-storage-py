...
with open("openapi/storage.transformed.openapi.yaml") as file:
...
_event_type_model_schema = json.loads(
    r"""{
  "type" : "string",
...
MODEL_DEFINITIONS.update({"EVENT_TYPE": _event_type_model_schema})
