...
class ObjectApi(WithApiClient):
    ...
    async def list(
        ...
        **kwargs,
        ...
        :param query['fetch_content_type'] (dict) <br> query.fetch_content_type (Query) : If true, fetch content type for each object when not already available from the listing (e.g. on s3 stores). This is less efficient but may be necessary for certain use cases.
